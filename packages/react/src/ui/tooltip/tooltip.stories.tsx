...
const meta: Meta<typeof Tooltip> = {
	...
	parameters: {
		...
		docs: {
			description: {
				component: 'Componente de tooltip para mostrar informações contextuais ao usuário.',
			},
		},
	},
	argTypes: {
...
export const LongContent: Story = {
	args: {
		content: 'Este é um tooltip com conteúdo muito longo que pode quebrar em múltiplas linhas para demonstrar como o componente lida com textos extensos.',
		maxWidth: 250,
