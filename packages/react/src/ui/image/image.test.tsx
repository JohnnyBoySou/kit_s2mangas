...
describe("Image", () => {
  ...
  it("should apply custom width and height", () => {
    render(
      <Image src="https://example.com/image.jpg" width={200} height={150} />,
    );
  ...
  it("should apply percentage width and height", () => {
    render(
      <Image src="https://example.com/image.jpg" width="50%" height="100%" />,
    );
    const container = screen.getByAltText("Image").parentElement;
  ...
  it("should apply different object-fit values", () => {
    const { rerender } = render(
      <Image src="https://example.com/image.jpg" objectFit="contain" />,
    );
  ...
  it("should use fallback image when provided", async () => {
    render(
      <Image src="invalid-url" fallback="https://example.com/fallback.jpg" />,
    );
    const img = screen.getByAltText("Image");
  ...
  it("should render with className", () => {
    render(
      <Image src="https://example.com/image.jpg" className="custom-image" />,
    );
    const container = screen.getByAltText("Image").parentElement;
