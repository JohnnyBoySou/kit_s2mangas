...
jest.mock("../icon/icon", () => {
  return function MockIcon({ name, size, color }: any) {
    return (
      <span data-testid={`icon-${name}`} style={{ fontSize: size, color }}>
        {name}
      </span>
    );
  };
...
describe("Dropdown", () => {
  ...
  it("should apply custom style when provided", () => {
    ...
    render(
      <Dropdown {...defaultProps} style={customStyle} testID="test-dropdown" />,
    );
  ...
  it("should position dropdown correctly based on position prop", () => {
    ...
    const { container } = render(
      <Dropdown {...defaultProps} position="bottom-right" />,
    );
  ...
  it("should position dropdown correctly for top-left position", () => {
    const { container } = render(
      <Dropdown {...defaultProps} position="top-left" />,
    );
  ...
  it("should handle items without onClick gracefully", () => {
    ...
    render(
      <Dropdown trigger={<button>Open</button>} items={itemsWithoutOnClick} />,
    );
