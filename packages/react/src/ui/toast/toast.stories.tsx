...
export const LongSuccessMessage: Story = {
	args: {
		success: 'Esta é uma mensagem de sucesso muito longa que pode ocupar mais espaço no toast para testar como o componente se comporta com textos extensos.',
		duration: 0,
	},
};
...
export const LongErrorMessage: Story = {
	args: {
		error: 'Esta é uma mensagem de erro muito longa que pode ocupar mais espaço no toast para testar como o componente se comporta com textos extensos e quebras de linha.',
		duration: 0,
	},
};
