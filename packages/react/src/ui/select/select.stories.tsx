...
export const LongOptions: Story = {
  args: {
    options: [
      {
        value: "option1",
        label: "Esta é uma opção muito longa que pode quebrar o layout",
      },
      {
        value: "option2",
        label: "Outra opção com texto extenso para testar o comportamento",
      },
      { value: "option3", label: "Opção normal" },
      {
        value: "option4",
        label: "Mais uma opção com texto longo para verificar o comportamento",
      },
    ],
