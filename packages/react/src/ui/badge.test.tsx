...
describe('Badge Component', () => {
  ...
  it('should render with different variants', () => {
    ...
    variants.forEach(variant => {
      const { unmount } = render(
        <Badge {...defaultProps} variant={variant as any} data-testid="badge" />
      );
  ...
  it('should render with className', () => {
    render(<Badge {...defaultProps} className="custom-badge" data-testid="badge" />);
  ...
  it('should apply destructive variant styles', () => {
    render(<Badge {...defaultProps} variant="destructive" data-testid="badge" />);
  ...
  it('should combine variant and size styles', () => {
    render(
      <Badge {...defaultProps} variant="destructive" size="lg" data-testid="badge" />
    );
