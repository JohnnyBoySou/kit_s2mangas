...
const Pagination: React.FC<PaginationProps> = ({
	...
	const getSizeStyles = () => {
		switch (size) {
			case 'small':
				return {
					button: { padding: '4px 8px', fontSize: '12px', minWidth: '28px', height: '28px' },
					icon: 12,
				};
			case 'large':
				return {
					button: { padding: '12px 16px', fontSize: '16px', minWidth: '44px', height: '44px' },
					icon: 20,
				};
			default:
				return {
					button: { padding: '8px 12px', fontSize: '14px', minWidth: '36px', height: '36px' },
					icon: 16,
				};
		}
	};
