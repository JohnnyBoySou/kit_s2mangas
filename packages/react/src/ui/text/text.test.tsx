...
describe("Text Components", () => {
  ...
  describe("Description Component", () => {
    ...
    it("should render with long text", () => {
      const longText =
        "This is a very long description text that should be properly rendered by the Description component. It contains multiple sentences and should test the component's ability to handle longer content.";
