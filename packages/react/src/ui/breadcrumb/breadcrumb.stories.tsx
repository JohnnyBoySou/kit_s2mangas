...
- Sempre marque o último item como página atual
  ...
  argTypes: {
    items: {
      description:
        "Array de itens do breadcrumb. Cada item deve ter id, label e opcionalmente href, icon e disabled.",
      control: { type: "object" },
      table: {
    ...
    onItemClick: {
      description:
        "Callback chamado quando um item é clicado. Recebe o item clicado como parâmetro.",
      action: "clicked",
      table: {
    ...
    separator: {
      description:
        "Tipo de separador entre os itens. Pode ser um dos tipos predefinidos ou uma string customizada.",
      control: { type: "select" },
    ...
    maxItems: {
      description:
        "Número máximo de itens visíveis antes de colapsar. Quando excedido, mostra primeiro item, ellipsis e últimos itens.",
    ...
    size: {
      description:
        "Tamanho do breadcrumb que afeta font-size, padding e tamanho dos ícones.",
      control: { type: "select" },
    ...
    style: {
      description:
        "Estilos inline customizados aplicados ao container principal.",
      control: { type: "object" },
      table: {
...
export const MinimalCollapse: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Breadcrumb com colapso mínimo, mostrando apenas primeiro e último item.",
      },
    },
  },
};
...
export const InteractiveExample: Story = {
      ...
      return currentPath.map((id, index) => ({
        ...
        href:
          index < currentPath.length - 1
            ? `/${currentPath.slice(1, index + 1).join("/")}`
            : undefined,
      }));
    };
    ...
    return (
      <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
        <div>
          ...
          <p>
            Clique nos itens do breadcrumb para navegar ou use os botões abaixo:
          </p>
        </div>

        <Breadcrumb items={getCurrentItems()} onItemClick={handleItemClick} />
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Exemplo interativo onde você pode navegar pelos níveis do breadcrumb.",
      },
    },
  },
};
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
        ...
        >
          ...
          <p style={{ margin: "0", color: "#6c757d" }}>
            Você está visualizando este produto na categoria: Loja → Roupas →
            Masculino → Camisetas
          </p>
        </div>
      </div>
