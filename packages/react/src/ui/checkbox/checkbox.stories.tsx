...
export const LongLabel = {
  args: {
    label: 'Este é um checkbox com um label muito longo que pode quebrar em múltiplas linhas para demonstrar como o componente se comporta com textos extensos',
    checked: false,
    disabled: false,
  },
};
...
export const StateComparison = {
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', minWidth: '300px' }}>
      ...
      <Checkbox label="Checkbox desabilitado e marcado" checked={true} disabled={true} />
    </div>
  ),
};
    ...
    return (
      <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', minWidth: '300px' }}>
        ...
        <div style={{ 
          ...
          <strong>Itens selecionados:</strong> {selectedItems.length > 0 ? selectedItems.join(', ') : 'Nenhum'}
        </div>
      </div>
    );
  },
    ...
    return (
      <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', minWidth: '300px' }}>
        ...
        <div style={{ 
          ...
          <strong>Selecionados:</strong> {selectedItems.length} de {items.length}
        </div>
      </div>
    );
  },
