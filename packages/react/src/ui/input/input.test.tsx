...
describe('Input Component', () => {
  ...
  it('should handle focus and blur events', async () => {
    ...
    render(<Input {...defaultProps} onFocus={onFocus} onBlur={onBlur} testID="input" />);
  ...
  it('should render with error message', () => {
    render(<Input {...defaultProps} error="This field is required" testID="input" />);
    
    expect(screen.getByText('This field is required')).toBeInTheDocument();
  });

  it('should render with helper text', () => {
    render(<Input {...defaultProps} helperText="This is helper text" testID="input" />);
  ...
  it('should render with different input types', () => {
    ...
    types.forEach(type => {
      const { unmount } = render(<Input {...defaultProps} type={type as any} testID="input" />);
  ...
  it('should handle controlled input', () => {
    ...
    fireEvent.change(input, { target: { value: 'controlled value additional' } });
    expect(defaultProps.onChange).toHaveBeenCalledWith('controlled value additional');
  });
