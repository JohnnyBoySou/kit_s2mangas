...
describe("Progress", () => {
  ...
  it("renders with different sizes", () => {
    ...
    sizes.forEach((size, index) => {
      const { unmount } = render(
        <Progress value={50} size={size} testID="progress" />,
      );
  ...
  it("renders with different variants", () => {
    ...
    variants.forEach((variant, index) => {
      const { unmount } = render(
        <Progress value={50} variant={variant} testID="progress" />,
      );
  ...
  it("shows text when showText is true and text is provided", () => {
    render(
      <Progress value={50} showText text="Custom text" testID="progress" />,
    );
  ...
  it("prioritizes custom text over percentage", () => {
    render(
      <Progress value={50} showPercentage text="Custom" testID="progress" />,
    );
  ...
  it("has correct accessibility attributes", () => {
    render(
      <Progress value={75} max={100} text="Loading data" testID="progress" />,
    );
