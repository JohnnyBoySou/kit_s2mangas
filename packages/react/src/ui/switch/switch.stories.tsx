  ...
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', minWidth: '300px' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
        ...
        <span style={{ fontFamily: 'Font_Book', fontSize: '14px', color: '#666' }}>
          Switch desabilitado
        </span>
      </div>
    ...
    return (
      <div style={{ display: 'flex', flexDirection: 'column', gap: '20px', minWidth: '400px' }}>
        <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: '16px' }}>
          <div style={{ flex: 1 }}>
            <h4 style={{ margin: '0 0 4px 0', fontFamily: 'Font_Bold', fontSize: '14px' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'flex-start', gap: '12px' }}>
          ...
          <div style={{ flex: 1 }}>
            <p style={{ 
              ...
              Concordo com os <span style={{ textDecoration: 'underline', cursor: 'pointer' }}>termos e condições</span> 
              e a <span style={{ textDecoration: 'underline', cursor: 'pointer' }}>política de privacidade</span>.
            </p>
            {showError && (
              <p style={{ 
                margin: '8px 0 0 0', 
