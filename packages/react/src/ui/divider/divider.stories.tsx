...
export const ThicknessComparison = {
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', minWidth: '400px' }}>
      <div>
        <p style={{ margin: '0 0 8px 0', fontFamily: 'Font_Book', fontSize: '14px' }}>
          Espessura: 1px
        </p>
        <Divider thickness={1} />
      </div>
  ...
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '24px', minWidth: '400px' }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
        ...
        <span style={{ fontFamily: 'Font_Medium', fontSize: '14px', color: '#666' }}>
          OU
        </span>
        <Divider style={{ flex: 1 }} />
      </div>
...
export const VerticalInLayout = {
  render: () => (
    <div style={{ display: 'flex', alignItems: 'stretch', minHeight: '200px', gap: '16px' }}>
      <div style={{ flex: 1 }}>
        <h3 style={{ margin: '0 0 8px 0', fontFamily: 'Font_Bold', fontSize: '16px' }}>
          Coluna Esquerda
        </h3>
...
export const WithSpacing = {
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '24px', minWidth: '400px' }}>
      <div>
        <h3 style={{ margin: '0 0 16px 0', fontFamily: 'Font_Bold', fontSize: '16px' }}>
          Título da Seção
        </h3>
        <p style={{ margin: '0', fontFamily: 'Font_Book', fontSize: '14px', color: '#666' }}>
  ...
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '24px', minWidth: '400px' }}>
      <div style={{ textAlign: 'center' }}>
        <h2 style={{ margin: '0 0 16px 0', fontFamily: 'Font_Bold', fontSize: '24px' }}>
          Título Principal
        </h2>
        <Divider 
          color="#007AFF" 
      ...
      <div style={{ textAlign: 'center' }}>
        <h3 style={{ margin: '0 0 16px 0', fontFamily: 'Font_Bold', fontSize: '18px' }}>
          Subtítulo
        </h3>
        <Divider 
          color="#FF6B6B" 
      ...
      <div style={{ textAlign: 'center' }}>
        <h4 style={{ margin: '0 0 16px 0', fontFamily: 'Font_Bold', fontSize: '14px' }}>
          Seção Menor
        </h4>
        <Divider 
          color="#28a745" 
  ...
  render: () => (
    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '20px', maxWidth: '800px' }}>
      <div style={{ 
        ...
        <h3 style={{ margin: '0 0 12px 0', fontFamily: 'Font_Bold', fontSize: '16px' }}>
          Card 1
        </h3>
        <p style={{ margin: '0 0 16px 0', fontFamily: 'Font_Book', fontSize: '14px', color: '#666' }}>
