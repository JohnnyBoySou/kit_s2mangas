...
describe("Pagination", () => {
  ...
  it("should show first/last buttons when showFirstLast is true", () => {
    render(
      <Pagination {...defaultProps} currentPage={5} showFirstLast={true} />,
    );
  ...
  it("should not show first/last buttons when showFirstLast is false", () => {
    render(
      <Pagination {...defaultProps} currentPage={5} showFirstLast={false} />,
    );
  ...
  it("should show page info when showPageInfo is true", () => {
    render(
      <Pagination {...defaultProps} currentPage={5} showPageInfo={true} />,
    );
  ...
  it("should not show page info when showPageInfo is false", () => {
    render(
      <Pagination {...defaultProps} currentPage={5} showPageInfo={false} />,
    );
  ...
  it("should apply className when provided", () => {
    ...
    expect(
      screen.getByText("1").closest(".custom-pagination"),
    ).toBeInTheDocument();
  });
