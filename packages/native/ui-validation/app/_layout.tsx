...
export default function RootLayout() {
  ...
  const [loaded] = useFonts({
    Font_Black: require('../core/src/fonts/Circular_Black.ttf'),
    Font_Bold: require('../core/src/fonts/Circular_Bold.ttf'),
    Font_Medium: require('../core/src/fonts/Circular_Medium.ttf'),
    Font_Book: require('../core/src/fonts/Circular_Book.ttf'),
  });
