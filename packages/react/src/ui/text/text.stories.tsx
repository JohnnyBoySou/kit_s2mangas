...
export const HeadTitleComponent = {
  render: () => (
    ...
    >
      ...
      <HeadTitle style={{ color: "#28a745" }}>
        HeadTitle com Cor Verde
      </HeadTitle>
      <HeadTitle style={{ textAlign: "right" }}>
        HeadTitle Alinhado à Direita
      </HeadTitle>
    </div>
  ),
};
...
export const DescriptionComponent = {
  render: () => (
    ...
    >
      <Description>
        Este é um texto descritivo que pode conter múltiplas linhas e
        informações detalhadas sobre algo.
      </Description>
      <Description style={{ color: "#fd7e14" }}>
        Descrição com cor laranja personalizada.
      </Description>
      <Description style={{ textAlign: "justify" }}>
        Este é um texto justificado que se distribui uniformemente entre as
        margens, criando um layout mais limpo e profissional.
      </Description>
    </div>
  ),
};
  ...
  render: () => (
    ...
    >
      <div>
        ...
        <Description>
          Description - Texto descritivo que pode conter múltiplas linhas e
...
export const InCard = {
  render: () => (
    ...
    >
      <Title style={{ marginBottom: "12px" }}>Produto Premium</Title>

      <HeadTitle style={{ marginBottom: "8px", color: "#007AFF" }}>
        R$ 99,90
      </HeadTitle>

      <Label style={{ marginBottom: "16px" }}>Categoria: Tecnologia</Label>

      <Description style={{ marginBottom: "16px" }}>
        Este é um produto de alta qualidade com recursos avançados e design
        moderno. Ideal para usuários que buscam performance e estilo.
      </Description>

      <SubLabel style={{ marginBottom: "8px" }}>Disponível em estoque</SubLabel>
...
export const InForm = {
  render: () => (
    ...
    >
      <Title style={{ marginBottom: "8px" }}>Formulário de Cadastro</Title>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
        ...
        <SubLabel>Seus dados estão seguros conosco</SubLabel>
      </div>
...
export const InList = {
  render: () => (
    ...
    >
      <HeadTitle style={{ marginBottom: "16px" }}>Lista de Tarefas</HeadTitle>
      ...
      <div style={{ display: "flex", alignItems: "flex-start", gap: "12px" }}>
        ...
        <div style={{ flex: 1 }}>
          ...
          <Description style={{ marginBottom: "12px", color: "#856404" }}>
            Você tem uma nova mensagem importante para visualizar. Clique no
            link abaixo para acessar.
          </Description>

          <U style={{ cursor: "pointer", color: "#856404" }}>Ver mensagem</U>
        </div>
      </div>
    </div>
  ),
  ...
  render: () => (
    ...
    >
      ...
      >
        ...
        <div>
          <Title style={{ marginBottom: "4px" }}>João Silva</Title>
          <SubLabel>Desenvolvedor Full Stack</SubLabel>
        </div>
      </div>
