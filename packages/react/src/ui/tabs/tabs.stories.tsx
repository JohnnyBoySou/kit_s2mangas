...
export const SingleTab: Story = {
  render: () => {
    ...
    return (
      <Tabs value={selectedTab} setValue={setSelectedTab} values={["Único"]} />
    );
  },
};
  ...
  render: () => {
    ...
    const handleTabChange = (tab: string) => {
      ...
      switch (tab) {
        case "Tab 1":
          setContent(
            "Conteúdo da Tab 1 - Esta é a primeira aba com informações importantes.",
          );
          break;
        case "Tab 2":
          setContent(
            "Conteúdo da Tab 2 - Segunda aba com dados diferentes e úteis.",
          );
          break;
        case "Tab 3":
          setContent(
            "Conteúdo da Tab 3 - Terceira aba com mais informações relevantes.",
          );
          break;
        default:
