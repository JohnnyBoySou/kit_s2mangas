...
describe('Divider Component', () => {
  ...
  it('should render with custom thickness for vertical orientation', () => {
    render(<Divider orientation="vertical" thickness={3} data-testid="divider" />);
  ...
  it('should handle zero thickness for vertical orientation', () => {
    render(<Divider orientation="vertical" thickness={0} data-testid="divider" />);
  ...
  it('should handle large thickness values for vertical orientation', () => {
    render(<Divider orientation="vertical" thickness={50} data-testid="divider" />);
  ...
  it('should handle both orientations with same thickness', () => {
    const { rerender } = render(<Divider thickness={10} data-testid="divider" />);
    
    let divider = screen.getByTestId('divider');
    expect(divider).toHaveStyle({ height: '10px' });
    
    rerender(<Divider orientation="vertical" thickness={10} data-testid="divider" />);
  ...
  it('should handle null and undefined props gracefully', () => {
    render(<Divider color={undefined} thickness={undefined} data-testid="divider" />);
