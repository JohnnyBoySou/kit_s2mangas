...
- Evite aninhar accordions muito profundamente
  ...
  argTypes: {
    items: {
      description:
        "Array de itens do accordion. Cada item deve ter id, title, content e opcionalmente icon e disabled.",
      control: { type: "object" },
      table: {
    ...
    allowMultiple: {
      description:
        "Permite que múltiplos itens sejam expandidos simultaneamente. Por padrão, apenas um item pode estar aberto.",
    ...
    defaultOpenItems: {
      description:
        "Array com os IDs dos itens que devem estar abertos por padrão ao carregar o componente.",
      control: { type: "object" },
      table: {
        type: { summary: "string[]" },
        defaultValue: { summary: "[]" },
    ...
    variant: {
      description:
        "Variante visual do accordion que define o estilo de apresentação.",
      control: { type: "select" },
    ...
    onItemToggle: {
      description:
        "Callback executado quando um item é expandido ou recolhido. Recebe o ID do item e o novo estado (aberto/fechado).",
      action: "item toggled",
      table: {
...
const basicItems: AccordionItem[] = [
  {
    ...
    content: (
      <div>
        ...
        <p>
          Desenvolvida pelo Facebook, é amplamente utilizada para criar
...
const itemsWithIcons: AccordionItem[] = [
  {
    ...
    content: (
      <div>
        ...
        <button style={{ padding: "8px 16px", marginTop: "8px" }}>
          Editar Perfil
        </button>
      </div>
    ),
...
export const InteractiveExample: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Exemplo interativo com callback de toggle. Verifique o console para ver os eventos.",
      },
    },
  },
};
