...
export const WithContent = {
  args: {
    children: (
      <div>
        <h3 style={{ margin: '0 0 12px 0', fontFamily: 'Font_Bold', fontSize: '18px' }}>
          Título do Card
        </h3>
        <p style={{ margin: '0 0 16px 0', fontFamily: 'Font_Book', fontSize: '14px', lineHeight: '1.5' }}>
          Este é um exemplo de card com conteúdo mais rico, incluindo título, texto e botão.
        </p>
        <button style={{
  ...
  args: {
    children: (
      <div>
        ...
        />
        <h3 style={{ margin: '0 0 8px 0', fontFamily: 'Font_Bold', fontSize: '16px' }}>
          Card com Imagem
        </h3>
        <p style={{ margin: '0', fontFamily: 'Font_Book', fontSize: '14px', color: '#666' }}>
...
export const StyleComparison = {
  render: () => (
    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '20px', maxWidth: '800px' }}>
      <Card>
        <h3 style={{ margin: '0 0 12px 0', fontFamily: 'Font_Bold', fontSize: '16px' }}>Padrão</h3>
      ...
      <Card shadow={false}>
        <h3 style={{ margin: '0 0 12px 0', fontFamily: 'Font_Bold', fontSize: '16px' }}>Sem Sombra</h3>
        <p style={{ margin: '0', fontFamily: 'Font_Book', fontSize: '14px' }}>
          Card sem sombra
        </p>
      </Card>
      ...
      <Card borderRadius={24}>
        <h3 style={{ margin: '0 0 12px 0', fontFamily: 'Font_Bold', fontSize: '16px' }}>Arredondado</h3>
        <p style={{ margin: '0', fontFamily: 'Font_Book', fontSize: '14px' }}>
      ...
      <Card backgroundColor="#FF6B6B">
        <h3 style={{ margin: '0 0 12px 0', fontFamily: 'Font_Bold', fontSize: '16px', color: 'white' }}>Colorido</h3>
        <p style={{ margin: '0', fontFamily: 'Font_Book', fontSize: '14px', color: 'white' }}>
          Card com cor personalizada
        </p>
      </Card>
    </div>
...
export const UsageExamples = {
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '24px', maxWidth: '800px' }}>
      ...
      <Card>
        <div style={{ display: 'flex', gap: '16px' }}>
          ...
          <div style={{ flex: 1 }}>
            ...
            <p style={{ margin: '0 0 12px 0', fontFamily: 'Font_Book', fontSize: '14px', color: '#666' }}>
              Descrição do produto com detalhes importantes.
            </p>
            <div style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
              <span style={{ fontFamily: 'Font_Bold', fontSize: '18px', color: '#007AFF' }}>
                R$ 99,90
              </span>
              <button style={{
                backgroundColor: '#007AFF',
      ...
      {/* Card de notificação */}
      <Card backgroundColor="#FFF3CD" onClick={() => alert('Notificação clicada!')}>
        <div style={{ display: 'flex', gap: '12px', alignItems: 'flex-start' }}>
          <div style={{ fontSize: '24px' }}>🔔</div>
          <div style={{ flex: 1 }}>
            <h4 style={{ margin: '0 0 4px 0', fontFamily: 'Font_Bold', fontSize: '14px', color: '#856404' }}>
              Nova Notificação
            </h4>
            <p style={{ margin: '0', fontFamily: 'Font_Book', fontSize: '13px', color: '#856404' }}>
      ...
      <Card>
        <div style={{ textAlign: 'center' }}>
          ...
          <h3 style={{ margin: '0 0 8px 0', fontFamily: 'Font_Bold', fontSize: '24px' }}>
            1,234
          </h3>
          <p style={{ margin: '0', fontFamily: 'Font_Book', fontSize: '14px', color: '#666' }}>
            Visualizações hoje
  ...
  render: () => (
    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '16px', maxWidth: '600px' }}>
      ...
      >
        <div style={{ textAlign: 'center' }}>
          <div style={{ fontSize: '32px', marginBottom: '8px' }}>🚀</div>
          <h3 style={{ margin: '0', fontFamily: 'Font_Bold', fontSize: '14px' }}>
            Card 1
          </h3>
        </div>
      </Card>
