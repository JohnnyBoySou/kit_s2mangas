  ...
  render: () => (
    <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
      <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
        ...
        <span style={{ fontFamily: "Font_Medium", color: "#51cf66" }}>
          Sucesso
        </span>
      </div>
      <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
        <Icon name="AlertCircle" color="#ffd43b" size={24} />
        <span style={{ fontFamily: "Font_Medium", color: "#ffd43b" }}>
          Aviso
        </span>
      </div>
      <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
        <Icon name="XCircle" color="#ff6b6b" size={24} />
        <span style={{ fontFamily: "Font_Medium", color: "#ff6b6b" }}>
          Erro
        </span>
      </div>
      <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
        <Icon name="Info" color="#339af0" size={24} />
        <span style={{ fontFamily: "Font_Medium", color: "#339af0" }}>
          Informação
        </span>
      </div>
    </div>
