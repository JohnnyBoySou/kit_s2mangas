...
const meta: Meta<typeof Progress> = {
	...
	parameters: {
		...
		docs: {
			description: {
				component: 'Componente de barra de progresso para mostrar o andamento de tarefas.',
			},
		},
	},
	argTypes: {
...
export const LoadingStates: Story = {
	render: () => (
		<div style={{ display: 'flex', flexDirection: 'column', gap: '30px', width: '300px' }}>
			<div>
			...
			<div>
				...
				<Progress value={100} variant="success" text="Processamento concluído!" />
			</div>
		</div>
	),
};