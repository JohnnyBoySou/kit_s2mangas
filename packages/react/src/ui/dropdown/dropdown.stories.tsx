...
- Considere o posicionamento baseado na localização do trigger
  ...
  argTypes: {
    ...
    closeOnItemClick: {
      description:
        "Define se o dropdown deve fechar automaticamente ao clicar em um item",
      control: { type: "boolean" },
      table: {
        type: { summary: "boolean" },
...
const basicItems: DropdownItem[] = [
  ...
  },
  {
    ...
    label: "Configurações",
    icon: "Settings",
    onClick: () => alert("Configurações clicado"),
  },
  ...
  args: {
    ...
    items: [
      ...
      },
      {
        ...
        icon: "X",
        disabled: true,
        onClick: () => alert("Não deve aparecer"),
      },
      { id: "divider1", label: "", divider: true },
      {
        id: "3",
        label: "Outro Item Ativo",
        icon: "Star",
        onClick: () => alert("Outro item ativo"),
      },
      {
        id: "4",
        label: "Outro Desabilitado",
        disabled: true,
        onClick: () => alert("Não deve aparecer"),
      },
    ],
    ...
    items: [
      {
        id: "1",
        label: "Item 1",
        onClick: () => alert("Item 1 - Menu permanece aberto"),
      },
      {
        id: "2",
        label: "Item 2",
        onClick: () => alert("Item 2 - Menu permanece aberto"),
      },
      {
        id: "3",
        label: "Item 3",
        onClick: () => alert("Item 3 - Menu permanece aberto"),
      },
    ],
  ...
  render: () => {
    const userItems: DropdownItem[] = [
      ...
      },
      {
        ...
        label: "Notificações",
        icon: "Bell",
        onClick: () => alert("Ver notificações"),
      },
      { id: "divider1", label: "", divider: true },
      {
        id: "4",
      ...
      <Dropdown
        trigger={
          ...
          >
            ...
            <div>
              <div style={{ fontSize: "14px", fontFamily: "Font_Medium" }}>
                João Silva
              </div>
  ...
  render: () => {
    const actionItems: DropdownItem[] = [
      ...
      },
      {
        ...
        label: "Compartilhar",
        icon: "Share",
        onClick: () => alert("Compartilhar item"),
      },
      { id: "divider1", label: "", divider: true },
      {
        id: "4",
    ...
    return (
      <div style={{ display: "flex", gap: "16px" }}>
        ...
        >
          <div>
            <div style={{ fontFamily: "Font_Medium", marginBottom: "4px" }}>
              Documento.pdf
            </div>
            <div style={{ fontSize: "12px", color: "#666" }}>
